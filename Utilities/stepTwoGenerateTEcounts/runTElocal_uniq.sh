...
JOURNAL=$EXPERIMENT/analyzed/$SAMPLEID/log/$(date +%Y-%m-%d_%H-%M).$commandNAME.$TEdb.uniq.log
...
outPrefix="$EXPERIMENT/analyzed/$SAMPLEID/TElocal/$SAMPLEID.TElocal.$TEdb.uniq"
